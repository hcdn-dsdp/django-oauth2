...
EMAIL_MESSAGE="Para recuperar su contraseña ingrese al siguiente link:  http://sparl.hcdn.gob.ar/#/cambiarPassword?token={0} \n\nEn caso de no haber solicitado este email, por favor ignórelo.\n\nSaludos cordiales. \n\nSistema Parlamentario Digital \nDirección de Servicios Digitales Parlamentarios"
EMAIL_MESSAGE_EXCEPTION="*** IGNORAR: PRUEBA LOCAL *** Hay una excepción para el usuario: \nCUIL: {0} \nNombre: {1} \nApellido: {2} \nEmail-bd: {3} \nEmail-nuevo: {4}"
